    ...
    <div className="soft-card overflow-hidden hover:-translate-y-1 transition-all">
      ...
      <div className="p-5 space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-lg text-slate-900 line-clamp-2">Apple Mac Pro Tower</h3>
        </div>
        <div className="flex items-center gap-2 text-sm">
          <span className="text-amber-500">Star 4.8</span>
        ...
        <p className="text-slate-600 text-sm line-clamp-2">
          The ultimate workstation with M2 Ultra chip, designed for heavy video editing and 3D
          rendering.
        </p>
        <div className="flex items-center justify-between">
        ...
        <button className="w-full button-primary py-2.5 rounded-lg font-semibold">Add to Cart</button>
      </div>
    </div>
  );
}
